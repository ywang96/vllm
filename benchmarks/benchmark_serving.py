...
async def benchmark(
    ...
    print("-" * 35)
    print("{:<25} {:<10}".format("Successful requests:", metrics.completed))
    print("{:<25} {:<10.2f}".format("Benchmark duration (s):", benchmark_duration))
    print("{:<25} {:<10}".format("Total input tokens:", metrics.total_input))
    print("{:<25} {:<10}".format("Total generated tokens:", metrics.total_output))
    print("{:<25} {:<10.2f}".format("Request throughput (requests/s):", metrics.request_throughput))
    print("{:<25} {:<10.2f}".format("Input token throughput (tokens/s):", metrics.input_throughput))
    print("{:<25} {:<10.2f}".format("Output token throughput (tokens/s):", metrics.output_throughput))
    print("{:<35}".format("TTFT: Time to First Token"))
    print("{:<25} {:<10.2f}".format("Mean TTFT (ms):", metrics.mean_ttft_ms))
    print("{:<25} {:<10.2f}".format("Median TTFT (ms):", metrics.median_ttft_ms))
    print("{:<25} {:<10.2f}".format("P99 TTFT (ms):", metrics.p99_ttft_ms))
    print("{:<35}".format("TPOT: Time per Output Token, excluding first token"))
    print("{:<25} {:<10.2f}".format("Mean TPOT (ms):", metrics.mean_tpot_ms))
    print("{:<25} {:<10.2f}".format("Median TPOT (ms):", metrics.median_tpot_ms))
    print("{:<25} {:<10.2f}".format("P99 TPOT (ms):", metrics.p99_tpot_ms))
    print("-" * 35)
